...
unsigned int nStakeMaxAge = 24 * 60 * 60 * 180; // 180 Days
...
const string strMessageMagic = "Cryptoniumcoin Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Cryptoniumcoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Cryptonium Coin CTC - Sept 26, 2017";
        CTransaction txNew;
        txNew.nTime = 1506442833;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1506442833;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 151605 : 151605;
        ...
        assert(block.hashMerkleRoot == uint256("0x89c344066f8b8aa31be4c118d3b4568bb9ac19bfd5286594707a4763950b6e55"));
...
unsigned char pchMessageStart[4] = { 0x9b, 0xa4, 0x0e, 0xc6 };
