...
const char * const BITCOIN_CONF_FILENAME = "cryptonium.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Cryptonium";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Cryptonium";
#else
    // Unix
    return pathRet / ".cryptonium";
#endif
#endif
}
